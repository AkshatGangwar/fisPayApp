...
namespace fisPayApp.Views.Updates;

public partial class UpdatePwdOTP : BasePopUp
{
    ...
    {
        InitializeComponent();
        var updatePwdOtpVM = new UpdatePwdOtpVM();
        BindingContext = updatePwdOtpVM;
        Routing.RegisterRoute(nameof(UpdatePwd), typeof(UpdatePwd));
